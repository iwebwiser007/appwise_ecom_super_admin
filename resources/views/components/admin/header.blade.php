...
ons__item-icon">
    ...
    <div class="dropdown sa-toolbar__item"><button class="sa-toolbar-user" type="button" id="dropdownMenuButton"
      ...
      <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
        <li><a class="dropdown-item" href="{{ url('admin/admin-profile') }}"> <i class="fas fa-user"></i> <span class="ms-2"></span>Profile</a>
        </li>

        <li><a class="dropdown-item" href="{{ url('admin/admin-details') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"
              fill="currentColor">
              <path
            ...
            </svg> <span class="ms-2"></span> Settings</a></li>
        <li>
        <li><a class="dropdown-item" href="{{ url('admin/update-admin-password') }}"> <i class=" fas fa-lock"></i> <span class="ms-2"></span> Password Change</a></li>
        <li>
          <hr class="dropdown-divider">
        </li>
        <li><a class="dropdown-item" href="{{ url('admin/logout') }}"> <i class="fas fa-sign-out-alt"></i> <span class="ms-2"></span> Log Out</a>
        </li>
      </ul>
    </div>
  </div>
